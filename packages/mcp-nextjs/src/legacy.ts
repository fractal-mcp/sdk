...
// Users should migrate to the new createFractalMcpRoute API
...
export function createAppRouteHandler(mcpServer: IMcpConnectable) {
  // Implementation omitted for brevity - same as before
  throw new Error("Legacy createAppRouteHandler not implemented in this version. Use createFractalMcpRoute instead.");
}
...
export function appRouteHealthHandler(_req: NextRequest): Response {
